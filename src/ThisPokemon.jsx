...
function PokeDetails() {
  ...
  function previousPokes(id) {
    const indexPoke = Pokemons.findIndex((pokemon) => pokemon.id === id);
    const previousIndexPoke =
      indexPoke === 0 ? Pokemons.length - 1 : indexPoke - 1;
  ...
  return (
    <div className="PokeContainer" style={{ backgroundColor: pokemon.color }}>
      ...
      <div className="pokecontainer">
        ...
        <h3 className="pAbout" style={{ color: pokemon.color }}>
          About
        </h3>
        ...
        <section className="sectionStats">
          <div className="stats">
            <label style={{ color: pokemon.color }} htmlFor="file">
              HP
            </label>
            <p>{pokemon.stats.HP}</p>
            <progress id="file" max="200" value={pokemon.stats.HP}>
              {pokemon.stats.HP}
            </progress>
          </div>
          <div className="stats">
